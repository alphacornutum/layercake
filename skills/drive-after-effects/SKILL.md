...
- `ae_eval_script` can mutate the open project and bypasses patch guards — say so when running destructive scripts. Write ExtendScript (ES3); modern JS is refused before the host — see `references/extendscript.md`.
