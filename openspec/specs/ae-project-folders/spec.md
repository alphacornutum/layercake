...
Expose a read-only MCP tool that returns the Project panel folder hierarchy as nested JSON so agents can skim project organization without reconstructing it from flat item lists.
