// @ts-nocheck
/** Inbound item-reference helpers, bundled into patch-apply. */
export function itemTypeNameForRefs(item) {
...
export function itemByIdForRefs(itemId) {
 ...
 */
export function collectItemRefs(item) {
  var refs = [];
